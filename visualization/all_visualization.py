...
def visualize_noun_embeddings_tsne(chroma_db_path, collection_name="lecture_embeddings", perplexity=30):
    """
    ...
    # ✅ 명사와 임베딩 데이터 추출
    nouns = [meta["lecture_name"] for meta in results["metadatas"] if "lecture_name" in meta]
    ...
    df_vis["lecture_name"] = nouns  # 명사 추가

    # ✅ Plotly를 이용한 시각화
    fig = px.scatter(
        df_vis, x="dim_1", y="dim_2", text="lecture_name",
